    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-end">
                <a href="{{ route('create.roles') }}" class="btn btn-primary">Create Role</a>
            </div>
                        ...
                        <tbody>
                            @foreach ($roles as $role)
                                <tr>
                                    ...
                                    <td>
                                       <span>
                                            <a href="{{ route('edit.roles', $role->id) }}" class="mr-4" data-toggle="tooltip" data-placement="top" title="Edit">
                                                <i class="fa fa-pencil color-muted"></i>
                                            </a>
                                              <form action="{{ route('destroy.roles', $role->id) }}" method="POST" class="delete-form" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        document.querySelectorAll('.delete-btn').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    title: 'Êtes-vous sûr de vouloir supprimer cette role ?',
